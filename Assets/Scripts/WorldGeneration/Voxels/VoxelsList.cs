...
public class VoxelsList
{
    ...
    public static void Init()
    {
        ...
        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(0, 2)",
                                  1, 3, false, 1, 3, false, 1, 3, false,
                                  1, 3, false, 1, 3, false, 1, 3, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(1, 2)",
                                  2, 3, false, 2, 3, false, 2, 3, false,
                                  2, 3, false, 2, 3, false, 2, 3, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(2, 2)",
                                  3, 3, false, 3, 3, false, 3, 3, false,
                                  3, 3, false, 3, 3, false, 3, 3, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(3, 2)",
                                  0, 1, false, 0, 1, false, 0, 1, false,
                                  0, 1, false, 0, 1, false, 0, 1, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(4, 2)",
		...
		selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(6, 2)",
		                          3, 7, false, 3, 7, false, 3, 7, false,
		                          3, 7, false, 3, 7, false, 3, 7, false,
		                          10);
		dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(7, 2)",
                                  5, 2, false, 5, 2, false, 5, 2, false,
                                  5, 2, false, 5, 2, false, 5, 2, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(0, 3)",
                                  6, 2, false, 6, 2, false, 6, 2, false,
                                  6, 2, false, 6, 2, false, 6, 2, false,
                                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);

        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(1, 3)",
        ...
        //Dirt
        selectedVoxel = InitVoxel(VoxelState.SOLID, VoxelType.ORGANIC, "(5, 3)",
                  2, 7, false, 2, 7, false, 2, 7, false,
                  2, 7, false, 2, 7, false, 2, 7, false,
                  10);
        dictionary.Add(selectedVoxel.name, selectedVoxel);
